...
from adet.evaluation.coco_evaluation import COCOEvaluator
from adet.data.assr_register import get_assr_dicts
from adet.data.assr_dataset_mapper import DatasetMapper
...
def main(args):
    ...
    dataset_dir = cfg.DATASETS.DATASETS_DIR
    for d in ['train', 'test']:
        DatasetCatalog.register("assr_" + d, lambda d=d: get_assr_dicts(
            root=dataset_dir, mode=d))
