...
from adet.evaluation.sor_eval import eval_sor
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        self._dataset_dir = cfg.DATASETS.DATASETS_DIR
        self._data_split = dataset_name.split('_')[1]
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            if "instances" in output:
                ...
                # instances = copy.deepcopy(output["instances"])
    ...
    def _eval_sor(self, predictions):
        ...
        res = eval_sor(map_path=str(self._saliency_map_dir) + '/', pred=predictions, dataset_root=self._dataset_dir, data_split=self._data_split)
...
def instances_to_coco_json(instances, img_id):
    ...
    ranks = instances.pred_ranks.tolist()
